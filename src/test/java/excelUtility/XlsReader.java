...
public class XlsReader {
	...
	public int getRowCount(String sheetName) {
      ...
      // get cel data
	    // 1-returns the data from a cell
	public String getCellData(String sheetName, String colName, int rowNum) {
		try {
		if (rowNum <= 0) // because 0 is the header of the excel sheet(no data on it)
		return "";
		...
		if (row.getCell(i).getStringCellValue().trim().equals(colName.trim()))
			//trim is used for eliminate leading and trailing spaces in the data 
		col_Num = i;
		}
		if (col_Num == -1)
		return "";
		...
		// System.out.println(cellText);
		 ...
		 return cellText;
			...
			// 2-returns the data from a cell
