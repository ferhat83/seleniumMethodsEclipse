...
public class XpathAndOtherLOcators {
	//-we have different type of locators the most used are : 1-id, 2-class, 3-className, 4-CSS(10 time faster than xpath), 5-Xpath.
	
	      //*** XPATH: we have Absolute xpath and Relative xpath
	               
	               // **A-Absolute xpath: we use single slash '/' 
	          // this type of xpath is so long and if there is any change in html nodes (codes) the Absolute xpath is not good any more 
	              
	               // **B-Relative xpath (we create them): we use double slash '//'
	                      //those type of xpath are short more efficient, also we can use sibling.
	
               // B1- xpath created with tag name and attribute name ex: //tagName[@attributeName ='value']
	                   // we can also use and to add an attributeName //tagName[@attributeName ='value'and @attributeName ='value']
			   ...
			   // B3- xpath created using contains ex: //tagName[contains(text(),'text value')]
		                 ...
		                 //******* parent to child & child to parent:
		                  //-1 parent to child:
		                      ...
		                      //  ex2:  //tagName[contains(text(),'text value')]//tagName[contains(text(),'text value')]
		                                           // parent                           child
		                  //-2 child to parent:
	         ...
	         //******* table Xpath:
	          ...
	          //NB: We can also use index ex:  //tagName[contains(text(),'text value')]/tagName[index]
